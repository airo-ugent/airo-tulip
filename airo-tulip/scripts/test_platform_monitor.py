...
def test():
    ...
    mobi.init_ethercat()
    mobi.driver.set_platform_velocity_target(0.0, 0.0, 0.1, timeout=2.0, only_align_drives=True)
    ...
    mobi.driver.set_platform_velocity_target(0.0, 0.0, 0.3, timeout=30.0)
